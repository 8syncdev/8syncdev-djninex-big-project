    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ManyToManyField(blank=True, to='app_v1.address')),
            ],
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='app_v1.category')),
                ('chapters', models.ManyToManyField(blank=True, to='app_v1.chapter')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_v1.instructor')),
                ('tags', models.ManyToManyField(blank=True, to='app_v1.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('content', models.TextField()),
                ('exercises', models.ManyToManyField(blank=True, to='app_v1.exercise')),
            ],
        ),
        migrations.AddField(
            model_name='chapter',
            name='lessons',
            field=models.ManyToManyField(blank=True, to='app_v1.lesson'),
        ),
        migrations.CreateModel(
            name='Notification',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courses', models.ManyToManyField(to='app_v1.course')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='lesson',
            name='reviews',
            field=models.ManyToManyField(blank=True, to='app_v1.review'),
        ),
        migrations.CreateModel(
            name='Submission',
            fields=[
                ...
                ('audit', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app_v1.audit')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_v1.submission')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='exercise',
            name='submissions',
            field=models.ManyToManyField(blank=True, to='app_v1.usersubmission'),
        ),
        migrations.AddIndex(
            model_name='user',
