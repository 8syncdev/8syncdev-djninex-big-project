# Generated by Django 5.1 on 2024-09-29 02:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addresses', models.ManyToManyField(blank=True, related_name='users', to='app_v1.address')),
            ],
            managers=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voucher', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course', to='app_v1.voucher')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('content', models.TextField()),
                ('url_doc', models.URLField(blank=True, max_length=500, null=True)),
                ...
                ('reviews', models.ManyToManyField(blank=True, related_name='lessons', to='app_v1.review')),
            ],
        ),
        migrations.AddField(
            model_name='chapter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('info', 'Info'), ('warning', 'Warning'), ('error', 'Error')], default='info', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('expired', 'Expired'), ('pending', 'Pending'), ('cancelled', 'Cancelled')], default='active', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('enrolled', 'Enrolled'), ('completed', 'Completed'), ('trial', 'Trial'), ('cancelled', 'Cancelled'), ('pending', 'Pending'), ('expired', 'Expired')], default='pending', max_length=50)),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('expiration_date', models.DateTimeField(default=datetime.datetime(2024, 9, 29, 2, 9, 39, 77723, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submissions', models.ManyToManyField(related_name='user_submissions', to='app_v1.submission')),
